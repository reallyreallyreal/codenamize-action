...
const _ = __webpack_require__(571);
...
parseParticles(__webpack_require__(341), allParticles);
...
module.exports.adjective = __webpack_require__(989);
module.exports.noun = __webpack_require__(812);
...
const codenamize_1 = __importDefault(__webpack_require__(449));
const input_enum_1 = __webpack_require__(637);
const output_enum_1 = __webpack_require__(801);
function isError(candidate) {
    return (typeof candidate === 'object' && !!candidate && 'message' in candidate);
}
...
function run() {
    try {
        const options = {
            seed: core.getInput(input_enum_1.Input.Seed, { required: true }),
            adjectiveCount: getInputAsInt(input_enum_1.Input.AdjectiveCount),
            particles: getInputAsArray(input_enum_1.Input.Particles),
            maxItemChars: getInputAsInt(input_enum_1.Input.MaxItemChars),
...
(function (Input) {
    Input["Seed"] = "seed";
    Input["AdjectiveCount"] = "adjective-count";
    Input["Particles"] = "particles";
    Input["MaxItemChars"] = "max-item-chars";
    Input["Capitalize"] = "capitalize";
...
var underscoreNodeF = __webpack_require__(641);
